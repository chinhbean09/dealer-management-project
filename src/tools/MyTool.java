...
public class MyTool {
    ...
    public static Date parseDate(String dateStr, String dateFormat) {
        ...
        //tạo ra một OBJ SimpleDateFormat từ định dạng dateFormat ,chính xác với định dạng của 
        //dateFormat mà ta truyền vào
        dF.applyPattern(dateFormat);  //biến dF dùng để apply format của tham số và áp dụng nó thông qua class SimpleDateFormat
        ...
        try {
            ...
            //Phương thức parse có chức năng chuyển đổi một chuỗi đại diện cho ngày tháng thành một đối tượng Date(đại diện cho thời gian nhất định)
            return new Date(t);
    ...
    //phương thức parseDate này có chức năng chuyển đổi một chuỗi đại diện cho ngày tháng thành 
    //một đối tượng Date dựa trên định dạng được chỉ định.Khi gọi phương thức parseDate, bạn cần cung cấp một chuỗi 
    //đại diện cho ngày tháng và một chuỗi định dạng để chỉ định cách đọc và chuyển đổi chuỗi đó thành đối tượng Date. 
    ...
    public static String dataToStr(Date date, String dateFormat) {
        ...
        //Phương thức format(date)sử dụng để chuyển đổi đối tượng Date thành chuỗi ngày tháng.
        //đã đc chỉ định.
        return dateStr;
        }
...
//hàm kiểm tra xem chuỗi nhập vào có rỗng không bằng cách sử dụng phương thức isEmpty()
    public static String readPattern(String message, String pattern){
//message: chuỗi thông báo để yêu cầu người dùng nhập chuỗi.
//pattern: chuỗi định dạng mẫu để kiểm tra xem chuỗi nhập vào có phù hợp với định dạng đó hay không.
        String input = "";
        boolean valid;
        do{
...
Đọc các dòng văn bản từ một tệp được chỉ định và trả về một danh sách các dòng văn bản đó.
 */
public static List<String> readLinesFromFile(String filename) {
    ...
    try {
        ...
        //FileReader là phương thức để tạo đối tượn đọc tệp văn bản được chỉ định bởi biến filename
...
//        System.out.println(dataToStr(d,"dd/MM/yyyy"));//OK, dataToStr sử dụng phương thức format(date)để chuyển nó thành chuỗi đã chỉ định sẵn 
