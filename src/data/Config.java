...
//Hàm readData trong class Config có tác dụng đọc dữ liệu từ tệp cấu hình config.txt,
//phân tích và lưu trữ thông tin về các tệp dữ liệu (accountFile, dealerFile, deliveryFile). 
  private void readData(){
//Với mỗi dòng trong lines, hàm này sẽ kiểm tra xem dòng đó có chứa từ khóa "ACCOUNT", "DEALER" hay "DELIVER" không
    ...
    //trong mảng parts sau khi đã split, thêm vào đường dẫn tương đối đến thư mục "DealerData".
